const Hero = () => {
  return (
    <div className="relative pt-64 bg-heroMobile md:bg-hero bg-no-repeat bg-[position:center_bottom] md:bg-[position:center] md:bg-cover flex flex-col justify-end lg:h-[900px] animate-fade-in">
      {/* Overlay */}
      ...
      <div className="relative z-10 h-full flex items-center justify-end flex-col container w-full gap-5 md:gap-4 md:mb-24 mb-16">
        <h1 className="font-antic text-2xl md:text-4xl lg:text-6xl text-white uppercase text-center leading-tight tracking-wide w-full animate-slide-up opacity-0 [animation-fill-mode:forwards]">
          Let’s create
