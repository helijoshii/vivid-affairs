  ...
  return (
    <div className="">
      <div>
        ...
        <h2
          className="font-arapey xl:text-5xl font-normal text-center uppercase mt-4 text-primary-500 text-2xl animate-slide-up opacity-0 [animation-fill-mode:forwards]"
      ...
      <div className="xl:mt-20 relative mt-5">
        {/* 01 */}
        <div
          className="flex justify-between container flex-col xl:flex-row animate-fade-in"
          style={{ animationDuration: "1.8s" }}
        >
          <div className="xl:w-1/2">
            <div className="flex items-center gap-8 justify-center xl:justify-start">
              <h2
                className="font-arapey text-5xl font-normal text-primary-500 hidden xl:block animate-slide-up opacity-0 [animation-fill-mode:forwards]"
                style={{ animationDelay: "0.3s" }}
              >
                01.
              </h2>
              <img
                src="/services/04_services.png"
                alt=""
            ...
            <div className="flex flex-col xl:gap-4 xl:mt-8 mt-2 xl:w-3/4 gap-2">
              <div className="flex items-end justify-center xl:justify-start">
                <h2
                  className="font-arapey md:text-5xl font-normal text-primary-500 text-4xl xl:hidden block animate-slide-up opacity-0 [animation-fill-mode:forwards]"
                  style={{ animationDelay: "0.3s" }}
                >
                  01.
                </h2>
                <h4
                  className="font-arapey md:text-3xl font-normal uppercase text-primary-500 text-2xl animate-slide-up opacity-0 [animation-fill-mode:forwards]"
              ...
              <p
                className="font-poppins text-base font-normal text-textColor leading-6 text-justify xl:text-justify animate-slide-up opacity-0 [animation-fill-mode:forwards]"
        ...
        {/* 02 */}
        <div
          className="flex justify-between xl:mt-24 relative container flex-col-reverse xl:flex-row mt-12 animate-fade-in"
          ...
          <div className="xl:w-1/2 xl:pl-16">
            ...
            <div className="flex flex-col gap-4 md:mt-8">
              <div className="flex items-end xl:justify-start justify-center">
                <h2
                  className="font-arapey text-4xl font-normal text-primary-500 md:text-5xl xl:hidden animate-slide-up opacity-0 [animation-fill-mode:forwards]"
                  style={{ animationDelay: "0.3s" }}
                >
                  02.
                </h2>
                <h4
                  className="font-arapey text-3xl font-normal uppercase text-primary-500 animate-slide-up opacity-0 [animation-fill-mode:forwards]"
                  style={{ animationDelay: "0.4s" }}
                >
                  Corporate Events
                </h4>
        ...
        {/* 03 */}
        <div
          className="flex justify-between mt-24 container flex-col xl:flex-row animate-fade-in"
        ...
        >
          <div className="xl:w-1/2">
            ...
            <div className="flex flex-col gap-4 mt-8">
              ...
              <p
                className="font-poppins text-base font-normal text-textColor leading-6 xl:w-3/4 text-justify md:text-justify animate-slide-up opacity-0 [animation-fill-mode:forwards]"
                style={{ animationDelay: "0.5s" }}
              >
