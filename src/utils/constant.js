...
export const NAVBAR_OPTIONS = [
  ...
  { id: "vendor", label: "VENDOR COLLABORATION", redirectTo: "#contact" },
];

export const DEPARTMENTS_OPTIONS = [
  "Website",
  "Social Media",
  "Wedding or Event Story",
  "Gifts",
  "Anchor",
  "Security",
  "Logistics",
...
export const TYPE_OF_EVENTS_OPTIONS = [
  "Wedding",
  "Corporate Event",
...
export const DISTRICTS_OPTIONS = {
  ...
  "West Bengal": [
    ...
    "Paschim Medinipur",
    "Purba Bardhaman",
    "Purba Medinipur adjacent to Bay of Bengal",
    "Purulia",
    "South 24 Parganas",
    "Uttar Dinajpur",
  ],
